...
import 'package:pupl_app/utils/custom/onBoarding/CustomOnBoardingWidget.dart';
import 'package:pupl_app/utils/custom/onBoarding/UI/pages.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Center(
                        ...
                        size: MediaQuery.of(context).size.height * 0.22,
                        color:
                            themeData.colorScheme.onBackground.withAlpha(190),
                      )),
                      SizedBox(height: 30.0),
                      Text(
                        'Secure payment\nwith SSL ',
